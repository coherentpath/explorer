defmodule Explorer.PolarsBackend.Native do
  ...
  def df_to_csv_gcs(_df, _ex_entry, _has_headers, _delimiter, _quote_style), do: err()
  ...
  def lf_from_parquet_gcs(_ex_gcs_entry, _stop_after_n_rows, _maybe_columns), do: err()
